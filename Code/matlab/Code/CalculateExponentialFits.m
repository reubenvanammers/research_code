function [ one_exp_params, one_exp_ave_error ,two_exp_params, two_exp_ave_error, error_fit,infinity_error] = CalculateExponentialFits(time,data)
...
options_1 = fitoptions('Method', 'NonLinearLeastSquares','Algorithm','Trust-Region','Start',initial,'TolFun',1e-12);
...
options_2 = fitoptions('Method', 'NonLinearLeastSquares','Algorithm','Trust-Region','Start',initial,'TolFun',1e-12,'Lower',[-Inf 0 0 0 0]);
