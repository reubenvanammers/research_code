...
options_1 = fitoptions('Method', 'NonLinearLeastSquares','TolFun',1e-11)%,'Algorithm','Levenberg-Marquardt');
...
options_1 = fitoptions('Method', 'NonLinearLeastSquares','Algorithm','Levenberg-Marquardt','Start',initial,'TolFun',1e-11);
...
options_2 = fitoptions('Method', 'NonLinearLeastSquares','Algorithm','Levenberg-Marquardt','Start',initial,'TolFun',1e-11);
