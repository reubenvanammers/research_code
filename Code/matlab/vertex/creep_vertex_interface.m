function [Time,Y,C2,flag] = creep_vertex_interface(lambda0,beta0,gamma0,alpha0,eta0,T0,tend,gridsize,ext_force,maxstrain)
...
[Time,Y] = ode15s(@cell_vertex_stress_reference_interface,0:0.2:tend,V_vec,options);
%final_hex = Y(end,:)';
C2 = C;
flag = strainflag;
