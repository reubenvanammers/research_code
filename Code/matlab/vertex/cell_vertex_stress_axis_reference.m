...
follow_force = (1-alpha).*vertex_internal_force_calc_axis2(C,V_ref,included_cell,lambda,beta,gamma,delta,A0_vec,reference_cell_areas,C0_vec,reference_cell_circumferences,axis_av,reference_axis_current);
fix_force = alpha*vertex_internal_force_calc_axis2(C,V_ref,included_cell,lambda,beta,gamma,delta,A0_vec,reference_cell_areas,C0_vec,reference_cell_circumferences,axis_0,reference_axis_current);
