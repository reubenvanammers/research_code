...
rstring = arrayfun(@(x) [' Ramptime = 10^{' num2str(x,3) '}'], linspace(rbounds{:}),'UniformOutput',false);
...
for ramptime_index = 1:t
    for alpha_index = 1:a_temp 
        for  eta_index = 1:g_temp
            ...
            plot(time(1:10:end),stress(1:10:end),'r.',time,exp1(time),'k-',time,exp2(time),'b--','MarkerSize',4)
%             plot(timecell3{vars{1:end-1}},stresscell3{vars{1:end-1}},'r',timecell3{vars{1:end-1}},exp1(timecell3{vars{1:end-1}}),'k--',timecell3{vars{1:end-1}},exp2(timecell3{vars{1:end-1}}),'b--',timecell3{vars{1:end-1}},exp2_1(timecell3{vars{1:end-1}}),'g-.',timecell3{vars{1:end-1}},exp2_2(timecell3{vars{1:end-1}}),'y-.')
            title([astring{(alpha_index-1)*a_scale+1}, estring{(eta_index-1)*g_scale+1}, rstring{ramptime_index}, Tstring{T_value} ]); 
            %legend('Data','Single Exp', 'Two Exp', 'Short Time', 'Long Time') 
            %axis([0 1 0 1]);
...
xlabel('Time')
ylabel('Stress')
%SaveAsPngEpsAndFig(-1,[pwd '/pictures/expfit/relaxation/timestress_threeexp/' num2str(Tvec(T_value)) '-' num2str(ramptimevec(ramptime_index)) '-' num2str(etavec(eta_index)) '-' num2str(alphavec(alpha_index))]  , 7, 7/5, 9)
%pause
...
plot(timecell3{vars{:}},stress-exp1(timecell3{vars{:}}),'k-',timecell3{vars{:}},stress-exp2(timecell3{vars{:}}),'b',timecell3{vars{:}},zeros(size(timecell3{vars{:}})),'r--')%,timecell3{vars{:}},strain-exp3(timecell3{vars{:}}),'g-.','MarkerSize',4)            %plot(timecell3{vars{1:end-1}},straincell3{vars{1:end-1}},'r',timecell3{vars{1:end-1}},exp1(timecell3{vars{1:end-1}}),'k--',timecell3{vars{1:end-1}},exp2(timecell3{vars{1:end-1}}),'b--',timecell3{vars{1:end-1}},exp2_1(timecell3{vars{1:end-1}}),'g-.',timecell3{vars{1:end-1}},exp2_2(timecell3{vars{1:end-1}}),'y-.')


%plot(timecell3{vars{:}},stress-exp1(timecell3{vars{:}}),'k-',timecell3{vars{:}},stress-exp2(timecell3{vars{:}}),'b',timecell3{vars{:}},stress-exp3(timecell3{vars{:}}),'g-.',timecell3{vars{:}},zeros(size(timecell3{vars{:}})),'r--','MarkerSize',4)
%plot(timecell3{vars{1:end-1}},stresscell3{vars{1:end-1}},'r',timecell3{vars{1:end-1}},exp1(timecell3{vars{1:end-1}}),'k--',timecell3{vars{1:end-1}},exp2(timecell3{vars{1:end-1}}),'b--',timecell3{vars{1:end-1}},exp2_1(timecell3{vars{1:end-1}}),'g-.',timecell3{vars{1:end-1}},exp2_2(timecell3{vars{1:end-1}}),'y-.')
%title([astring{alpha_index}, estring{eta_index}, rstring{ramptime_index}, Tstring{T_value} ]); 
%legend('Data','Single Exp', 'Two Exp', 'Short Time', 'Long Time') 
%axis([0 1 0 1]);
...
for T_index = 1
    ...
    %             %pause
                ...
                time = timecell3{vars{:}}; stress = stresscell3{vars{:}};
                plot(timecell3{vars{:}},stress-exp1(timecell3{vars{:}}),'k-',timecell3{vars{:}},stress-exp2(timecell3{vars{:}}),'b',timecell3{vars{:}},zeros(size(timecell3{vars{:}})),'r--')%,timecell3{vars{:}},stress-exp3(timecell3{vars{:}}),'g-.','MarkerSize',4)            %plot(timecell3{vars{1:end-1}},stresscell3{vars{1:end-1}},'r',timecell3{vars{1:end-1}},exp1(timecell3{vars{1:end-1}}),'k--',timecell3{vars{1:end-1}},exp2(timecell3{vars{1:end-1}}),'b--',timecell3{vars{1:end-1}},exp2_1(timecell3{vars{1:end-1}}),'g-.',timecell3{vars{1:end-1}},exp2_2(timecell3{vars{1:end-1}}),'y-.')
                title([astring{alpha_index}, estring{eta_index}, rstring{ramptime_index}, Tstring{T_index} ]); 
                %legend('Data','Single Exp', 'Two Exp', 'Short Time', 'Long Time') 
                %axis([0 1 0 1]);
                xlabel('Time')
