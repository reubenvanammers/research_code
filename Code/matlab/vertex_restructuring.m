...
global t_rec C_rec A_rec T fixlist movelist eta restoring_rec counter included_cell cell_history
sidelength = 1/sqrt(3);
...
[Time,Y] = ode15s(@cell_vertex_stress_restructuring,0:0.2:tend,V_vec,options);
final_hex = Y(end,:)';
